...
import android.content.Context // 🚨 FIX: यह मिसिंग इम्पोर्ट अब जोड़ दिया गया है
 ...
 * UPDATE: Immortality Protocol (Battery Exemption + Background Hacks) - FIXED IMPORTS.
 */
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Rule 1: स्क्रीन और CPU को जागृत रखें
        window.addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON)

        // 🚨 IMMORTALITY HACK 1: बैटरी ऑप्टिमाइज़ेशन से बाहर निकलने का अनुरोध
    ...
    private fun requestBatteryExemption() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // Context.POWER_SERVICE का सही इस्तेमाल
